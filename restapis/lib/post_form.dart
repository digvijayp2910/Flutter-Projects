                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          ...
                          print('Name: $name, Salary: $salary, Age: $age  ${controller.hashCode}');

                          if(GetUtils.isNum(salary)&& GetUtils.isNum(age) && GetUtils.isNull(name)==false){
                            ...
                            Get.snackbar("Wrong Details", "Please fill details properly");
                          }
